...
public class ListRSSItemsActivity_S extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		Log.d(TAG,"website");
		WebSite site = rssDB.getSportsRow(site_id); //apply switch case for each of the India,Entertainment,Sports,Technology!!! <--later-->
		...
		ListAdapter adapter = new SimpleAdapter(
				ListRSSItemsActivity_S.this, rssItemList,
	...
	class loadRSSFeedItems extends AsyncTask<String, String, String> {
		...
		protected void onPreExecute() {
			...
			super.onPreExecute();
			pDialog = new ProgressDialog(ListRSSItemsActivity_S.this);
