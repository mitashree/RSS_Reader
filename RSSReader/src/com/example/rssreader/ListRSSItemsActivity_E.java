...
public class ListRSSItemsActivity_E extends Activity{
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		Log.i(TAG,"intent, extra: " + (getIntent().getStringExtra(Entertainment.TAG_ID)));
		Intent i = getIntent();
		Integer site_id = Integer.parseInt(i.getStringExtra(Entertainment.TAG_ID));
		RSSDatabaseHandler rssDB = new RSSDatabaseHandler(getApplicationContext());

		Log.d(TAG,"website");
		WebSite site = rssDB.getEntertainmentRow(site_id); //apply switch case for each of the India,Entertainment,Sports,Technology!!! <--later-->
		...
		ListAdapter adapter = new SimpleAdapter(
				ListRSSItemsActivity_E.this, rssItemList,
	...
	class loadRSSFeedItems extends AsyncTask<String, String, String> {
		...
		protected void onPreExecute() {
			...
			super.onPreExecute();
			pDialog = new ProgressDialog(ListRSSItemsActivity_E.this);
